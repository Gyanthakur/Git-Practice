  ...
  return (
    <div className='flex items-center gap-3 mt-5 ml-1 mb-2 max-md:mt-4'>
      ...
      <Link 
        ...
        className="group transition transform hover:scale-110 text-[#c2baba] hover:text-gray-700"
      >
        <GithubLogo size={34} weight="fill" className="transition-colors duration-300" />
      </Link>
      <Link 
        target='_blank' 
        to='https://github.com/Gyanthakur/Git-Practice'
      ...
      <Link 
        ...
        className="group transition transform hover:scale-110 text-[#30e383] hover:text-green-500"
      >
